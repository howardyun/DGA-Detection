...
cnn_scores = [0.9272, 0.9284, 0.9616]
lstm_scores = [0.9198, 0.9207, 0.9576]
mit_scores = [0.9074, 0.9123, 0.9507]
bbyb_scores = [0.9262, 0.9275, 0.9611]
transformer_scores = [0.9150, 0.9177, 0.9549]
smad_scores = [0.9275, 0.9289, 0.9618]
...
ax.set_ylabel('Scores', fontsize=17)
...
# Show the plot
plt.tight_layout()
plt.savefig('200w_1比7_lb_org_bin_lb.pdf', format='pdf')
