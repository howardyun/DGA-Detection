...
cnn_scores = [0.9264, 0.9177, 0.9612]
lstm_scores = [0.8994, 0.9042, 0.9462]
mit_scores = [0.9249, 0.9259, 0.9604]
bbyb_scores = [0.9247, 0.9279, 0.9603]
transformer_scores = [0.9267, 0.9289, 0.9522]
smad_scores = [0.9324, 0.9401, 0.9665]
...
# Show the plot
plt.tight_layout()
plt.savefig('200w_1比4_lb_org_bin_lb.pdf', format='pdf')
