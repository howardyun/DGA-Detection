...
cnn_scores = [0.9234, 0.9265, 0.9596]
lstm_scores = [0.9353, 0.9357, 0.9615]
mit_scores = [0.9342, 0.9354, 0.9654]
bbyb_scores = [0.9038, 0.9042, 0.9487]
transformer_scores = [0.9336, 0.9377, 0.9669]
smad_scores = [0.9374, 0.9385, 0.9694]
...
# Show the plot
plt.tight_layout()
plt.savefig('200w_1比3_lb_org_bin_lb.pdf', format='pdf')
